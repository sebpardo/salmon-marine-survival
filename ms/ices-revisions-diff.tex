...
%DIF ADD ms.tex                   Thu May 27 00:09:46 2021
...
\begin{equation}
log(smolts\DIFdelbegin \DIFdel{_{obs,t,r}}\DIFdelend \DIFaddbegin \DIFadd{_{obs,r,t}}\DIFaddend ) = log(smolts\DIFdelbegin \DIFdel{_{true,t,r}}\DIFdelend \DIFaddbegin \DIFadd{_{true,r,t}}\DIFaddend ) + \epsilon\DIFdelbegin \DIFdel{_{t,r}}\DIFdelend \DIFaddbegin \DIFadd{_{r,t}}\DIFaddend ,
\end{equation}

where \DIFdelbegin \DIFdel{$smolts_{true,t,r}$ }\DIFdelend \DIFaddbegin \DIFadd{$smolts_{true,r,t}$ }\DIFaddend are the true smolt abundances for \DIFdelbegin \DIFdel{year $t$ and }\DIFdelend river
$r$ \DIFdelbegin \DIFdel{, and $\epsilon_{t,r}$ }\DIFdelend \DIFaddbegin \DIFadd{and year $t$, and $\epsilon_{r,t}$ }\DIFaddend is the error term, which is calculated from the yearly
coefficient of variation in the empirically derived
smolt estimates (see \DIFdelbegin \DIFdel{Table S1 }\DIFdelend \DIFaddbegin \DIFadd{Tables S4-6 }\DIFaddend in the Supplementary \DIFdelbegin \DIFdel{material}\DIFdelend \DIFaddbegin \DIFadd{Materials}\DIFaddend ).
...
}\DIFaddend (see Table \DIFdelbegin \DIFdel{S2 }\DIFdelend \DIFaddbegin \DIFadd{S5 }\DIFaddend in the Supplementary \DIFdelbegin \DIFdel{material}\DIFdelend \DIFaddbegin \DIFadd{Materials}\DIFaddend ).
The log-transformed true smolt abundances are
normally distributed around a population-level mean and standard deviation:

\begin{equation}
log(smolts\DIFdelbegin \DIFdel{_{true,t,r}}\DIFdelend \DIFaddbegin \DIFadd{_{true,r,t}}\DIFaddend ) \sim Normal(\mu_{smolts,r}, \sigma_{smolts,r})
\end{equation}
...
\begin{align}
    R\DIFdelbegin \DIFdel{_{1,t} }\DIFdelend \DIFaddbegin \DIFadd{_{r,1,t} }\DIFaddend &= smolts\DIFdelbegin \DIFdel{_{true,t-1} }\DIFdelend \DIFaddbegin \DIFadd{_{true,r,t-1} }\DIFaddend * S\DIFdelbegin \DIFdel{_{1,t} }\DIFdelend \DIFaddbegin \DIFadd{_{1,r,t} }\DIFaddend * P\DIFdelbegin \DIFdel{_{g,t} }\DIFdelend \DIFaddbegin \DIFadd{_{g,r,t} }\DIFaddend \label{eq:1}, \\
    R\DIFdelbegin \DIFdel{_{2,t+1} }\DIFdelend \DIFaddbegin \DIFadd{_{r,2,t+1} }\DIFaddend &= smolts\DIFdelbegin \DIFdel{_{true,t-1} }\DIFdelend \DIFaddbegin \DIFadd{_{true,r,t-1} }\DIFaddend * S\DIFdelbegin \DIFdel{_{1,t} }\DIFdelend \DIFaddbegin \DIFadd{_{1,r,t} }\DIFaddend * (1 - P\DIFdelbegin \DIFdel{_{g,t}}\DIFdelend \DIFaddbegin \DIFadd{_{g,r,t}}\DIFaddend ) * S\DIFdelbegin \DIFdel{_{2,t+1}}\DIFdelend \DIFaddbegin \DIFadd{_{2,r,t+1}}\DIFaddend , \label{eq:2}
\end{align}

where \DIFdelbegin \DIFdel{$R_{1,t}$ and $R_{2,t+1}$ }\DIFdelend \DIFaddbegin \DIFadd{$R_{1,r,t}$ and $R_{2,r,t+1}$ }\DIFaddend are the estimated abundances of 1SW and 2SW
salmon returning \DIFaddbegin \DIFadd{for river $r$ }\DIFaddend in years $t$ and $t+1$, respectively, \DIFdelbegin \DIFdel{$smolts_{true,t-1}$ }\DIFdelend \DIFaddbegin \DIFadd{$smolts_{true,r,t-1}$ }\DIFaddend is the
estimated number of out-migrating smolts \DIFaddbegin \DIFadd{for river $r$ }\DIFaddend in year $t-1$, \DIFdelbegin \DIFdel{$S_{1,t}$ }\DIFdelend \DIFaddbegin \DIFadd{$S_{1,r,t}$ }\DIFaddend is the proportion of
salmon surviving in their first year ($t$) at sea \DIFaddbegin \DIFadd{for river $r$}\DIFaddend , $P_{g,t}$ is the proportion of
salmon that return to spawn at year $t$ \DIFdelbegin \DIFdel{, $S_{2,t+1}$ }\DIFdelend \DIFaddbegin \DIFadd{for river $r$, and $S_{2,r,t+1}$ }\DIFaddend is the survival in their
second year at sea of the same cohort of salmon who did not return to spawn at
year $t$ \DIFaddbegin \DIFadd{for river $r$}\DIFaddend .
...
\begin{align}
 S\DIFdelbegin \DIFdel{_{1} }\DIFdelend \DIFaddbegin \DIFadd{_{1,r,t} }\DIFaddend &= e\DIFdelbegin \DIFdel{^{-Z_1}}\DIFdelend \DIFaddbegin \DIFadd{^{-Z_{1,r,t}}}\DIFaddend , \\
 S\DIFdelbegin \DIFdel{_{2} }\DIFdelend \DIFaddbegin \DIFadd{_{2,r,t} }\DIFaddend &= e\DIFdelbegin \DIFdel{^{-Z_2}}\DIFdelend \DIFaddbegin \DIFadd{^{-Z_{2,r,t}}}\DIFaddend .
\end{align}

The priors for $Z_1$ and $Z_2$ are specified as log-normal distributions:

\begin{align}
Z\DIFdelbegin \DIFdel{_1 }\DIFdelend \DIFaddbegin \DIFadd{_{1,r,t} }\DIFaddend &\sim logNormal(1, 0.22),   \\
Z\DIFdelbegin \DIFdel{_2 }\DIFdelend \DIFaddbegin \DIFadd{_{2,r,t} }\DIFaddend &\sim logNormal(0.2, 0.3).
\end{align}
...
\DIFaddbegin \DIFadd{We explored the effect of using weaker priors for $Z_1$, $Z_2$ and }\Pg\DIFadd{, and found
that the posteriors of $Z_1$ were not sensitive to the choice of prior, while the 
 posteriors $Z_2$ and }\Pg \DIFadd{became more uncertain with weaker priors while maintaining
...
Lastly, to determine \DIFdelbegin \DIFdel{what parameters best explains }\DIFdelend \DIFaddbegin \DIFadd{which parameters best explain }\DIFaddend the number of returns in
...
\begin{figure}[htbp]
 \centering
    ...
    \caption{Posterior probability distributions resulting from the population-level estimates of the proportion returning after one winter at sea based on
        the parameters \prmu and \prsig. Gray lines denote population-specific median estimates of \DIFdelbeginFL %DIFDELCMD < \prmu %%%
\DIFdelFL{and }%DIFDELCMD < \prsig%%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$P_{g,r}$}\DIFaddendFL , while
...
\DIFdelbegin \DIFdel{The }\DIFdelend Campbellton had mostly non-significant pairwise correlations with other populations, even though there are both positive and negative correlation coefficients, except with the Saint-Jean
...
\DIFaddbegin \DIFadd{Our choice of priors affected these correlations:
using weaker priors for }\So \DIFadd{and }\St \DIFadd{resulted in slightly different coefficients and significance thresholds (see Fig. S7 of Supplementary Materials). 
}\DIFaddend 

\begin{figure}[htbp] \centering
    \includegraphics[width=0.95\linewidth]{figures/corrplot-post-z1-corrected.png} \caption{
        Correlations of estimated trends in \DIFaddbeginFL \DIFaddFL{instantaneous natural mortality in the first winter at sea, }\DIFaddendFL $Z_1$\DIFaddbeginFL \DIFaddFL{, }\DIFaddendFL among populations.
...
while \DIFdelbegin \DIFdel{other exhibits }\DIFdelend \DIFaddbegin \DIFadd{others exhibit }\DIFaddend highly variable yet stationary trends, and some show declines.
...
\DIFaddbegin \DIFadd{Another potential mechanism is if smolt quantity and quality are negatively
...
}\DIFaddend Correlations between return estimates and survival were negative for
...
these parameters for any of the populations examined\DIFaddbegin \DIFadd{, at least for those population appreciable contributions of 2SW salmon}\DIFaddend .
...
Salmon Research Joint Venture\DIFaddbegin \DIFadd{.
GHB was funded by the Norwegian Research Council (projects 275862 and 280308)}\DIFaddend .
