...
Observation error was included as the standard deviation of the log-transformed
...
\begin{figure}[htbp] \centering
    \includegraphics[width=0.95\linewidth]{figures/priors.png} \caption{Priors
...
\begin{figure}[htbp] \centering
    ...
    \caption{Posterior estimates of \Pg for the seven rivers examined, error
        ...
        year of 1SW return.} \label{fig:pr-faceted} \end{figure}
